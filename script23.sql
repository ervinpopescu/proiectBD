...
CREATE TABLE tblClient (
    idClient MEDIUMINT ZEROFILL UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE tblMasina (
    idMasina SMALLINT ZEROFILL UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE tblLocatie (
    idLocatie TINYINT ZEROFILL UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
    adresa VARCHAR(200),
    codPostal CHAR(6),
    email VARCHAR(100),
    nrTelefon VARCHAR(20)
...
CREATE TABLE tblInchiriere (
    idInchiriere INT ZEROFILL UNSIGNED NOT NULL UNIQUE AUTO_INCREMENT,
    idClient MEDIUMINT ZEROFILL UNSIGNED NOT NULL,
    idMasina SMALLINT ZEROFILL UNSIGNED NOT NULL,
    dataInchiriere DATE NOT NULL,
    dataPredareLimita DATE NOT NULL,
    dataPredareEfectiva DATE DEFAULT NULL,
...
CREATE TABLE tblPlata (
    idPlata INT ZEROFILL UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
